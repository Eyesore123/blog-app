...
export default function SuggestedPosts({ slug }: { slug: string }) {
  ...
  return (
    <div className="w-full flex flex-col items-center md:items-start !mt-6 md:!mt-8 !pt-4 md:!pt-6 border-t border-[#5800FF]/20 xl:!ml-32 xl:w-4/5">
        {/* Apply theme colors to h3 */}
      <h3 className="{`font-semibold text-base md:text-lg ${theme === 'white' ? 'text-black' : 'text-white'}`} !mb-14 !pl-10">Suggested posts for you:</h3>
